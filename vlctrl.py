...
if __name__ == '__main__':
    ...
    parser.add_option('-v', '--verbose', action='store_true', help='print error messages about problems with the interface.', dest='verbose', default=False)
    ...
    vlct = VlcTalker(options.verbose)
